...
// ============================================
// RÉCUPÉRATION DE LA BLACKLIST POUR SMS
// ============================================
$blacklistIds = [];
if ($smsTypeId) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action_enregistrer'])) {
    ...
    if (empty($message)) {
        ...
        if ($type_envoi === 'simple') {
            ...
            if (!empty($contact)) {
                $destinataires[] = $contact[0]['telephone'];
                $destinatairesNoms[] = $contact[0]['prenom'] . ' ' . $contact[0]['nom'] . ' (' . $contact[0]['telephone'] . ')';
            }
        } else {
        ...
        try {
            ...
            // 🔥 REDIRECTION VERS LE CHOIX DU PROVIDER SMS
...
<head>
    ...
    <title>Composer le SMS - <?= APP_NAME ?></title>
    ...
    <style>
        ...
        * { 
        ...
        .type-envoi-option.border-blue-500 {
            border-color: #3b82f6;
...
<div class="container">
    ...
    <div class="header-section">
        ...
        <div class="header-text">
            <div class="title">Composer le SMS</div>
        ...
        <form method="POST" id="composerForm">
            ...
            <div class="form-group">
                ...
                <div class="type-envoi-grid">
                    <div id="typeSimple" 
                         class="type-envoi-option <?= (!isset($_POST['type_envoi']) || $_POST['type_envoi'] == 'simple') ? 'border-blue-500' : '' ?>">
                        <i class="fas fa-user text-blue-600"></i>
                        <div class="option-title">Envoi unique</div>
                        <div class="option-desc">À un seul destinataire</div>
                    </div>
                    <div id="typeMultiple" 
                         class="type-envoi-option <?= (isset($_POST['type_envoi']) && $_POST['type_envoi'] == 'multiple') ? 'border-blue-500' : '' ?>">
            ...
            <div id="simpleZone" class="form-group">
                <label class="form-label"><i class="fas fa-user"></i> Destinataire <span class="required">*</span></label>
                ...
                <?php if (count($contacts) < count($tousContacts)): ?>
                    <div class="blacklist-warning">
                        ...
                        <span><?= (count($tousContacts) - count($contacts)) ?> contact(s) blacklisté(s) pour les SMS ne sont pas affichés.</span>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div id="multipleZone" class="form-group" style="display: none;">
                ...
                <p class="text-xs text-gray-500 mt-1">
                    ...
                    Les contacts blacklistés pour les SMS seront automatiquement exclus.
                </p>
            </div>
            
            <!-- ===== MESSAGE ===== -->
            <div class="form-group">
                <label class="form-label"><i class="fas fa-comment"></i> Message <span class="required">*</span></label>
                ...
                <div class="flex-between mt-1">
                    ...
                    <span class="text-xs text-gray-500">1 SMS = 160 caractères</span>
                </div>
            </div>
...
function setTypeEnvoi(type) {
    if (type === 'simple') {
        typeSimple.classList.add('border-blue-500');
        typeSimple.classList.remove('border-gray-200');
        typeMultiple.classList.remove('border-blue-500');
        ...
        typeMultiple.classList.add('border-blue-500');
        typeMultiple.classList.remove('border-gray-200');
        typeSimple.classList.remove('border-blue-500');
...
if (messageTextarea) {
    ...
    charCounter.textContent = initialLength + ' caractères';
    if (initialLength > 160) {
        charCounter.classList.add('danger');
    } else if (initialLength > 140) {
        charCounter.classList.add('warning');
    }
}
